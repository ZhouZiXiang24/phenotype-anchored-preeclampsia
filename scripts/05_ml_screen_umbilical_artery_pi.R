# Machine-learning screening for umbilical artery pulsatility index
...
# Select umbilical artery pulsatility index as the regression outcome.
clinicalrow<-as.data.frame(inputclinical[5,])
...
pdf(file.path(figure_dir, "rmse_umbilical_artery_pi.pdf"), width = cellwidth * ncol(result5) + 5, height = cellheight * nrow(result5) * 0.45)
draw(hm)
invisible(dev.off())
