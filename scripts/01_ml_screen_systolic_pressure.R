# Machine-learning screening for systolic pressure
...
# Select systolic pressure as the regression outcome.
clinicalrow<-as.data.frame(inputclinical[1,])
...
pdf(file.path(figure_dir, "rmse_systolic_pressure.pdf"), width = cellwidth * ncol(result5) + 5, height = cellheight * nrow(result5) * 0.45)
draw(hm)
invisible(dev.off())
